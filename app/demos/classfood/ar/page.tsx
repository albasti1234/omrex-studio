...
const t = {
    ...
    location: { title: 'الموقع وأوقات العمل', address: 'جمعية بني ياس التعاونية، أبوظبي', floor: '7JQR+27 Abu Dhabi', hours: 'يومياً من 10 صباحاً - 11 مساءً', mapsBtn: 'افتح في خرائط قوقل' },
