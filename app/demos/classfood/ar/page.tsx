...
function CheckoutSheet({ onClose }: { onClose: () => void }) {
    ...
    const sendWhatsApp = () => {
        ...
        let msg = `🍽️ *طلب جديد*%0A📦 ${orderNumber}%0A👤 ${formData.name}%0A📞 ${formData.phone}%0A📍 ${formData.orderType === 'pickup' ? t.checkout.pickup : t.checkout.delivery}%0A%0A*الطلب:*%0A`;
