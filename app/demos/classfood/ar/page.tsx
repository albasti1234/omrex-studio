...
const t = {
    ...
    location: { title: 'الموقع وأوقات العمل', address: 'جمعية بني ياس التعاونية', floor: 'Food Court - 2nd Floor - Bani Yas - EB9 - Abu Dhabi', hours: 'يومياً من 10 صباحاً - 11 مساءً', mapsBtn: 'افتح في خرائط قوقل' },
    ...
    return (
        <section className="py-16 overflow-hidden bg-gradient-to-b from-zinc-900 via-zinc-800 to-zinc-950">
            <div className="text-center mb-10 px-6">
                <h2 className="cf-heading-lg text-white mb-2">📸 من مطبخنا</h2>
                <p className="text-zinc-400">أطباق طازجة كل يوم</p>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-10 mb-12">
                    ...
                    <div className="text-center">
                        <p className="text-gray-400 text-sm mb-2">اتصل بنا</p>
                    ...
                    <div className="text-center md:text-left">
                        <p className="text-gray-400 text-sm mb-3">اللغة</p>
                        <div className="flex justify-center md:justify-start gap-3">
                            <Link href="/demos/classfood/ar" className="bg-orange-500 px-5 py-2.5 rounded-full font-semibold text-sm">العربية</Link>
                            <Link href="/demos/classfood/en" className="bg-gray-800 hover:bg-gray-700 px-5 py-2.5 rounded-full font-semibold text-sm transition-colors">English</Link>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="p-6 space-y-5">
                                ...
                                {formData.paymentMethod === 'card' && (
                                    <div className="bg-blue-50 rounded-2xl p-4 space-y-4 border-2 border-blue-200">
                                        ...
                                        <p className="text-xs text-gray-500 text-center">🔐 بياناتك مشفرة وآمنة 100%</p>
                                    </div>
                                )}
