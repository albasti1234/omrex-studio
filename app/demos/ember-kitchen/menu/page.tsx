        ...
        <div className="flex items-center justify-start gap-2 py-4 overflow-x-auto hide-scrollbar">
          {categories.map((cat, index) => (
            <button
              ...
              className={`relative px-4 py-2 font-body text-[11px] tracking-[0.15em] uppercase whitespace-nowrap transition-all ${
                active === index
                  ? "text-[#d4a574]"
  ...
  />
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-baseline justify-between gap-3 mb-1.5">
            <h3 className={`font-display text-lg leading-tight transition-colors duration-300 ${
              item.signature 
                ? "text-[#d4a574]" 
                : isHovered 
                  ? "text-[#d4a574]" 
